...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Add method of the PersonQueue class was adding a new person to the beginning of the list instead of to the end.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The code does not correctly handle cases where a person has 0 turns.
    ...
    // Defect(s) Found: The code does not correctly handle cases where a person has a negative number of turns.
